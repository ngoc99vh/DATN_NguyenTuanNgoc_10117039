...
public class NoAccep_Store_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_no_accep__store_, container, false);
        ...
        rcl_store = view.findViewById(R.id.rcl_home_store_noacc);
        ...
        mDatabaseRef.orderByChild("pChuxe").equalTo(userName).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (upload.getpStatus().equals("Chưa xác nhận")) {
                        mUploads.add(upload);
                    }
